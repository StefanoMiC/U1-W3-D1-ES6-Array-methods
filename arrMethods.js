...
const arrOfNums = [60, 1, 50, 10, 100];

let sum = 0;

console.log("PRIMA", sum);

arrOfNums.forEach(num => (sum += num));

console.log("DOPO", sum);

console.log(arrOfNums);

let reducedSum = arrOfNums.reduce((accumulator, currentElement) => {
...
// const newMoviesArr = movies.reduce((accumulator, currentElement) => {
//   console.log("Accumulator", accumulator);
//   console.log("Current Element", currentElement);

//   return accumulator.concat({ title: currentElement.Title });
// }, []);

// const newMoviesArr = movies.reduce(
//   (accumulator, currentElement) => accumulator.concat({ title: currentElement.Title }),
//   []
// );
const newMoviesArr = movies.reduce(
  (accumulator, currentElement) => [...accumulator, { title: currentElement.Title }],
  []
);
